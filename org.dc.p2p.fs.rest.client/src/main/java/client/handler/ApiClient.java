...
import client.handler.auth.Authentication;
import client.handler.auth.HttpBasicAuth;
import client.handler.auth.ApiKeyAuth;
import client.handler.auth.OAuth;

public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "http://localhost:5050/p2pfs";
